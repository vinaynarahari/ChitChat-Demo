...
with_node \
  ...
  --target "/Users/vinaynarahari/Desktop/Github/flick-d/FlickD/ios/Pods/Target Support Files/Pods-ChitChat/ExpoModulesProvider.swift" \
  --entitlement "/Users/vinaynarahari/Desktop/Github/flick-d/FlickD/ios/ChitChat/ChitChat.entitlements" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo" "expo-application" "expo-asset" "expo-av" "expo-background-fetch" "expo-blur" "expo-camera" "expo-clipboard" "expo-constants" "expo-contacts" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-localization" "expo-location" "expo-notifications" "expo-router" "expo-secure-store" "expo-speech" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-updates" "expo-web-browser"
